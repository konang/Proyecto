...
#Descripción general: Documento que crea el modelo para el problema
...
class Problem < ActiveRecord::Base
  ...
  validates_numericality_of :value, :allow_nil => false, :greater_than => 0 , :message => "Debe tener un valor que sea mayor a 0"
  validates_numericality_of :idprob, :allow_nil => false, :greater_than => 0 , :message => "Solo datos numericos"
end
