...
#Descripción general: Documento que crea el modelo para la semana
...
validates_numericality_of :semana, :allow_nil => false, :message => "No se puede dejar la semana vacia"
end
